...
The best way to understand types is to look at the [code](https://github.com/Nuwton/looksrare-sdk/tree/master/src/types) directly. However, here is some documentation about the main types.
